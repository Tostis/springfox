...
public class ApiListingBuilder {
  ...
  public ApiListingBuilder apiVersion(String apiVersion) {
    this.apiVersion = BuilderDefaults.defaultIfAbsent(
        apiVersion,
        this.apiVersion);
    return this;
  }
  ...
  public ApiListingBuilder basePath(String basePath) {
    this.basePath = BuilderDefaults.defaultIfAbsent(
        basePath,
        this.basePath);
    return this;
  }
  ...
  public ApiListingBuilder resourcePath(String resourcePath) {
    this.resourcePath = BuilderDefaults.defaultIfAbsent(
        resourcePath,
        this.resourcePath);
    return this;
  }
  ...
  public ApiListingBuilder appendProduces(List<String> produces) {
    this.produces.addAll(BuilderDefaults.nullToEmptyList(produces).stream()
  ...
  public ApiListingBuilder appendConsumes(List<String> consumes) {
    this.consumes.addAll(BuilderDefaults.nullToEmptyList(consumes).stream()
        .filter(Objects::nonNull)
        .collect(toSet()));
    return this;
  }
  ...
  public ApiListingBuilder host(String host) {
    this.host = BuilderDefaults.defaultIfAbsent(
        host,
        this.host);
    return this;
  }
  ...
  public ApiListingBuilder description(String description) {
    this.description = BuilderDefaults.defaultIfAbsent(
        description,
        this.description);
    return this;
  }
  ...
  public ApiListingBuilder tagNames(Set<String> tagNames) {
    this.tagNames.addAll(BuilderDefaults.nullToEmptySet(tagNames).stream()
        .filter(Objects::nonNull)
        .collect(toSet()));
    return this;
  }
  ...
  public ApiListingBuilder availableTags(Set<Tag> availableTags) {
    this.tagLookup.putAll(BuilderDefaults.nullToEmptySet(availableTags).stream()
        .collect(toMap(
            Tag::getName,
            identity())));
    return this;
