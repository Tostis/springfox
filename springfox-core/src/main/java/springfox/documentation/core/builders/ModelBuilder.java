...
public class ModelBuilder {
  ...
  public ModelBuilder name(String name) {
    this.name = BuilderDefaults.defaultIfAbsent(
        name,
        this.name);
    return this;
  }
  ...
  public ModelBuilder qualifiedType(String qualifiedType) {
    this.qualifiedType = BuilderDefaults.defaultIfAbsent(
        qualifiedType,
        this.qualifiedType);
    return this;
  }
  ...
  public ModelBuilder baseModel(String baseModel) {
    this.baseModel = BuilderDefaults.defaultIfAbsent(
        baseModel,
        this.baseModel);
    return this;
  }
  ...
  public ModelBuilder discriminator(String discriminator) {
    this.discriminator = BuilderDefaults.defaultIfAbsent(
        discriminator,
        this.discriminator);
    return this;
  }
  ...
  public ModelBuilder example(Object example) {
    this.example = BuilderDefaults.defaultIfAbsent(
        example,
        this.example);
    return this;
  }
  ...
  public ModelBuilder type(ResolvedType modelType) {
    this.modelType = BuilderDefaults.defaultIfAbsent(
        modelType,
        this.modelType);
    return this;
  }
  ...
  public ModelBuilder xml(Xml xml) {
    this.xml = BuilderDefaults.defaultIfAbsent(
        xml,
        this.xml);
    return this;
  }
