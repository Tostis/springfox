...
import static springfox.documentation.core.builders.ElementFacets.*;
...
public class SimpleParameterSpecificationBuilder {
  ...
  public SimpleParameterSpecificationBuilder explode(Boolean explode) {
    this.explode = BuilderDefaults.defaultIfAbsent(Boolean.TRUE.equals(explode) ? true : null, this.explode);
    return this;
  }
  ...
  public SimpleParameterSpecificationBuilder allowEmptyValue(Boolean allowEmptyValue) {
    this.allowEmptyValue = BuilderDefaults.defaultIfAbsent(Boolean.TRUE.equals(allowEmptyValue) ? true : null, this.allowEmptyValue);
    return this;
  }
