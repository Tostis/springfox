...
public class ParameterBuilder {
  ...
  public ParameterBuilder parameterType(String paramType) {
    if (!StringUtils.isEmpty(paramType)) {
      this.paramType = BuilderDefaults.defaultIfAbsent(ParameterType.valueOf(paramType.toUpperCase()), this.paramType);
    }
    return this;
  }
  ...
  public ParameterBuilder parameterAccess(String paramAccess) {
    this.paramAccess = BuilderDefaults.defaultIfAbsent(BuilderDefaults.emptyToNull(paramAccess), this.paramAccess);
    return this;
  }
  ...
  public ParameterBuilder allowEmptyValue(Boolean allowEmptyValue) {
    this.allowEmptyValue = BuilderDefaults.defaultIfAbsent(allowEmptyValue, this.allowEmptyValue);
    return this;
  }
