...
public class PropertySpecificationBuilder {
  ...
  public PropertySpecificationBuilder readOnly(Boolean readOnly) {
    this.readOnly = BuilderDefaults.defaultIfAbsent(Boolean.TRUE.equals(readOnly) ? true : null, this.readOnly);
    return this;
  }

  public PropertySpecificationBuilder writeOnly(Boolean writeOnly) {
    this.writeOnly = BuilderDefaults.defaultIfAbsent(Boolean.TRUE.equals(writeOnly) ? true : null, this.writeOnly);
    return this;
  }
